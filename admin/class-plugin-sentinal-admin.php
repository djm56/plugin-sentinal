 ...
 * @subpackage Plugin_Sentinal/admin
 */
...
class Plugin_Sentinal_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Plugin_Sentinal_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Plugin_Sentinal_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/plugin-sentinal-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/plugin-sentinal-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function add_plugin_admin_menu() {
		 ...
		 */
		add_submenu_page( 'plugins.php', 'Plugin settings page title', 'Plugin Sentinal', 'manage_options', $this->plugin_name, array( $this, 'display_plugin_setup_page' ) );
